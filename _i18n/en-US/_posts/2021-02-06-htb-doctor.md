...
Starting to posting about some write-ups of CTF-like machines, the first one will be **Doctor**, an easy-rated Linux box from [Hack The Box](https://www.hackthebox.eu) created by  cri [egotisticalSW](https://app.hackthebox.eu/users/94858).<!--more-->

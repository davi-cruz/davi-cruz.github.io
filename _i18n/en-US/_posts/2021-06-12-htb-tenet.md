...
As accessing the webpage again from the url `http://10.10.10.223/wordpress` errors are shown, as the image below, accessed the address saw in source code (`http://tenet.htb`) full blog is displayed.
